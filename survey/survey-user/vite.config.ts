...
export default defineConfig({
  ...
  plugins: [
    ...
    Vue({
      ...
      template: {
        compilerOptions: {
          isCustomElement: (tag: string) => tag.startsWith('survey'),
        },
      },
    }),
    ...
    //         tag: 'script',
    //         attrs: {
    //           src: 'https://cdn.jsdelivr.net/npm/survey-core@1.9.63/survey.i18n.min.js',
    //           defer: true,
    //         },
    //       },
    //       {
    ...
    //         tag: 'link',
    //         attrs: {
    //           src: 'https://cdn.jsdelivr.net/npm/survey-core@1.9.63/modern.min.css',
    //         },
    //       },
    //       {
    //         injectTo: 'body',
    //         tag: 'script',
    //         attrs: {
    //           src: 'https://cdn.jsdelivr.net/npm/survey-analytics@1.9.63/survey.analytics.min.js',
    //           defer: true,
    //         },
    //       },
    //       {
    ...
    //         tag: 'link',
    //         attrs: {
    //           src: 'https://cdn.jsdelivr.net/npm/survey-analytics@1.9.63/survey.analytics.min.css',
    //         },
    //       },
    //     ],
    //   },
