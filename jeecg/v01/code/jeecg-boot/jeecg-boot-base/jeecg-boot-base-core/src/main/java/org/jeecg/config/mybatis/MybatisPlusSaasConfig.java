...
//                session.getAttribute("tenantId");
                //String tenantId = oConvertUtils.getString((String)redisUtil.get("tenantId"+request.getHeader(CommonConstant.X_ACCESS_TOKEN)),"0");
                //String tenantId = oConvertUtils.getString(TenantContext.getTenant(),"0");
                String tenantId = oConvertUtils.getString(request.getHeader(CommonConstant.TENANT_ID),"0");
