...
public class JwtFilter extends BasicHttpAuthenticationFilter {
    ...
    protected boolean preHandle(ServletRequest request, ServletResponse response) throws Exception {
        ...
        //session.setAttribute("tenantId", httpServletRequest.getHeader(CommonConstant.TENANT_ID));
        String tenantId = httpServletRequest.getHeader(CommonConstant.TENANT_ID);


        System.out.println("设置多租户id："+tenantId);
//        System.out.println("=====设置多租户id："+redisUtil.get("tenantId"+httpServletRequest.getHeader("token"))+"=====tenantId"+httpServletRequest.getHeader("token"));
        TenantContext.setTenant(tenantId);
        //update-end-author:taoyan date:20200708 for:多租户用到
        String host = request.getServerName();
        System.out.println("realmNAme:"+host);
