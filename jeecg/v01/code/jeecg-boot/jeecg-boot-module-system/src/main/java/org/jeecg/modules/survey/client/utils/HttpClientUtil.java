...
public class HttpClientUtil {
    ...
    public static String doPost(String url, JSONObject json){
        ...
        postMethod.addRequestHeader("X-Access-Token", "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJleHAiOjE2NTcwMjE3MTksInVzZXJuYW1lIjoiYWRtaW4ifQ.5LGZNYiajvei7BuyfiXctPh-CGDrBksjHSBQND7ps78");
        postMethod.addRequestHeader("tenant-id", "707465217");
