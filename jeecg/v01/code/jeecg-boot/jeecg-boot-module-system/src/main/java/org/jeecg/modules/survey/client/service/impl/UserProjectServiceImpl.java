...
public class UserProjectServiceImpl extends ServiceImpl<UserProjectMapper, UserProject>
    ...
    @Autowired
    private SurQuestionProjectMapper userSurveyQuestionMapper;
    @Autowired
    private SurQuestionChoiceProjectMapper userSurveyChoiceMapper;
    @Autowired
    ...
    @Autowired
    private SurEvaluationRelationshipMapper relationshipMapper;
    @Autowired
    ...
    @Autowired
    private SurQuestionChoiceMapper surQuestionChoiceMapper;
    @Autowired
    private SurUserSurveyMapper surUserSurveyMapper;
    @Autowired
    private SurSurveyTenantMapper surSurveyTenantMapper;
    @Autowired
    ...
    @Autowired
    private SurProjectEnableMapper surProjectEnableMapper;
    @Autowired
