...
public interface ISysUserService extends IService<SysUser> {
	...
	Boolean setUserEmail(SysUser user, String email);

	//通过租户id获取用户名
	String getUserNameByTenantId(String tenantId);

	//修改用户手机号
	Boolean setUserPhone(SysUser user, String phone);
	...
	/*管理员通过用户id修改用户积分*/
	Boolean putUserIntegral(String userId, Integer integral);
}
